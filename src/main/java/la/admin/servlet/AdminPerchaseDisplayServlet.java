 ...
 */
@WebServlet("/AdminPurchaseDisplayServlet")
public class AdminPerchaseDisplayServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (session != null && session.getAttribute("admin_id") != null) {
				...
				RequestDispatcher rd = request.getRequestDispatcher("/Admin/AdminDisplayPerchase.jsp");
